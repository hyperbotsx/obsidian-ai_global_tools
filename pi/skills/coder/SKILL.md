...
12. PR creation is human-managed; do not create or open PRs unless the user explicitly asks.
...
5. If final bug-check is approved, stop and summarize validation; do not create a PR unless the user asks.
