...
Read first:
dev-plans/agentops/coder-verifier-workflow/runs/session-1780907664062/coder-ready.md

Then verify against:
dev-plans/agentops/coder-verifier-workflow/runs/session-1780907664062/coder-handoff.md
dev-plans/agentops/coder-verifier-workflow/runs/session-1780907664062/decision-log.md
all changed files named in coder-ready.md

Run preflight first when available:
scripts/agentops/verifier-preflight.py dev-plans/agentops/coder-verifier-workflow/runs/session-1780907664062
