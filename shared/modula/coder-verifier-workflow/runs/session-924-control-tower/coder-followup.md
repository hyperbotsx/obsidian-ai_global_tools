...
Report:
dev-plans/agentops/coder-verifier-workflow/runs/session-924-control-tower/verifier-report.md

Machine summary:
- Decision: `approved`
- Next actor: `unknown`
- Status validation: failed (missing Open findings; missing Bug-check status; missing Next actor). Stop and ask the verifier to correct verifier-report.md before proceeding.
